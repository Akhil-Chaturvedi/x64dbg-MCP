...
// Plugin info
constexpr auto PLUGIN_NAME = "x64dbg MCP";
constexpr auto PLUGIN_AUTHOR = "akhil";
constexpr auto PLUGIN_VERSION = 1;
constexpr auto PLUGIN_VERSION_STR = "1.0";
constexpr auto PLUGIN_REPO_URL = "https://github.com/akhil-chaturvedi/x64dbg-MCP";
